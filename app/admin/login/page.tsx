  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5 flex items-center justify-center p-4">
      <Card className="w-full max-w-md p-8 border border-primary/20">
        ...
        <p className="text-center text-muted-foreground mb-8">Radio Station CMS</p>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          {error && (
            <div className="p-3 bg-red-500/10 border border-red-500/30 rounded text-red-500 text-sm">{error}</div>
          )}
        ...
        <div className="mt-6 p-4 bg-secondary/30 rounded-lg text-sm text-muted-foreground">
          ...
          <p>Email: admin@radiostation.com</p>
