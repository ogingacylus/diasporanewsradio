...
export default function AdvertisementsPage() {
  ...
  const filteredPremium = ads?.filter((ad) => ad?.premium)?.length;
  const filteredLocal = ads?.filter((ad) => !ad?.premium)?.length;
  useEffect(() => {
    fetchAds();
  }, []);
                    ...
                    >
                      ...
                      <div className="p-5">
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="mt-4 flex items-center justify-center gap-2 w-full py-2 bg-secondary/50 hover:bg-secondary text-secondary-foreground text-sm font-medium rounded-lg transition-colors"
                        >
                          Visit Website
