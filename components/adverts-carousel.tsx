...
export function AdvertsCarousel({events_}: { events_: any }) {
            ...
            <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
              ...
              <Link href="/#about">
                ...
                <div className="mb-8">
                    ...
                    <p className="mt-2 text-muted-foreground">
                        Check out products and services of Diaspora News Radio partners.
                    </p>
                </div>
                    ...
                    <div
                        ...
                        <div className="mt-4">
                            <Link href={`/advertisements`}>
                                <button
                                    className="px-6 py-2 bg-accent text-accent-foreground rounded-lg font-medium hover:opacity-90 transition-opacity cursor-pointer">
                                    Learn More
                                </button>
                            </Link>
                        </div>
