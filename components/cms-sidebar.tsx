...
import {
    ...
    MessageSquareDot,
    MessageCircleMore,
    HeartHandshakeIcon, MessageCircle,
} from "lucide-react";
    ...
    return (
        <>
            ...
            <div>
                {isOpen && (
                    <aside
                        className="w-64 bg-secondary border-r border-primary/20 h-screen flex flex-col p-6 flex md:hidden absolute z-50 transform transition-all duration-700 ease-in-out">
