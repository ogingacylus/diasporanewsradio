...
export function Hero() {
  return (
    <section id="home" className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-primary/10 to-background">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          {/* Left Content */}
          <div className="space-y-6">
            <div className="inline-block px-4 py-2 rounded-full border border-accent/30 bg-accent/5">
              <span className="text-sm font-medium text-accent">Broadcasting Since 2015</span>
            </div>
            ...
            <p className="text-lg text-muted-foreground max-w-md leading-relaxed">
              Connect with millions of listeners across the globe. Experience premium content, exclusive interviews, and
              music that moves you.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <button className="px-8 py-3 bg-accent text-accent-foreground rounded-lg font-medium hover:opacity-90 transition-opacity flex items-center justify-center gap-2">
                <Volume2 size={20} />
                Listen Live Now
              </button>
              <button className="px-8 py-3 border-2 border-accent text-accent rounded-lg font-medium hover:bg-accent/5 transition-colors">
                Learn More
              </button>
            </div>
          </div>
