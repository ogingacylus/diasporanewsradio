            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                      ...
                      <span className="text-xs font-medium text-accent mb-2 block">
                        {ad.category}
                                            ...
                                            <div
                                                className="flex  items-center gap-2 text-xs text-muted-foreground pt-4 ">
                ...
                <div className="bg-gray-50 rounded-lg border border-border p-8 mt-6">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        {submitted && (
                            <div
                                className="bg-green-500/20 border border-green-500/50 text-green-700 rounded-lg p-4 text-center">
