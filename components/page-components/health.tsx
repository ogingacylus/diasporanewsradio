...
export function Health({ news_, color }: { news_: any; color: any }) {
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl">
            Stay updated with the latest health news and updates from our health
            experts
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {news_.map((article: any) => (
              <Link href={`/health/${article.id}`} key={article.id}>
