...
export default function StoriesDetail({ story }: { story: any }) {
  ...
  return (
    <div className="">
      {loading ? (
        ...
        <div className="pt-32 py-24 flex items-center justify-center">
          <div>
            {" "}
            <h1 className="text-4xl font-bold text-foreground mb-4">
              Story Not Found
            </h1>
            <p className="text-muted-foreground mb-8 flex items-center justify-center">
